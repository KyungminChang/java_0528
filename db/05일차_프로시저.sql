...
# 학번, 강의번호, 중간, 기말, 수행, 과제, 출석이 주어지면 학점을 계산해서 추가하는 프로시저를 생성해보세요.
...
USE CGV;
# 예매자 아이디, 예매 상영시간 번호, 성인수, 청소년 수가 주어지면 예매하는 프로시저를 생성하고 테스트
...
BEGIN
	...
	SET _MORNING = (SELECT SD_EARYLY FROM SCHDULE WHERE SD_NUM = _SD_NUM);
    CASE _MORNING
		WHEN 1 THEN
		...
		END CASE;
        INSERT INTO TICKETING VALUES(NULL, _ADULT, _TEENAGER, _ADULT_PRICE + TEENAGER_PRICE, _ID, _SD_NUM);
