...
INSERT INTO MEMBER VALUES('abmin1','admin1','ADMIN');
# 영화 정보를 추가하는 작업을 해보세요.(데드풀과 울버린)
# 1. 영화 정보를 추가 : 제목, 내용, 시간, 연령대, 개봉일
INSERT INTO MOVIE values(NULL, '데드풀과 울버린', '히어로 생활에서 은퇴한 후...', 127, '청소년관람불가', '2024-07-24');
...
INSERT INTO person VALUES(NULL, '라이언 레이놀즈', '1976-10-23', '<엑스맨 탄생: 울버린>...', '캐나다'),
(NULL, '휴 잭맨', '1968-10-12', '호주 출신 배우인 휴 잭맨은 ...', '오스트레일리아'),
(NULL, '엠마 코린', '1999-12-13', '', ''),
...
INSERT INTO theater VALUES(NULL, 'CGV강남', 3, 30,'서울특별시 강남구 역삼동 814-6 스타플렉스', '서울');
...
# 1관 : A1~A3, B1~B3, C1~C4
# 2관 : A1~A4, B1~B4, C1~C2
# 3관 : A1~A2, B1~B2, C1~C2, D1~D4
# 4관 : A1~A6, B1~B6
INSERT INTO theater VALUES(NULL, 'CGV영등포', 4, 44,'서울특별시 영등포구 영등포동 4가 441-10번지 경방 타임스퀘어', '서울');
INSERT INTO SCREEN VALUES(NULL, '1관', 10, 2),(NULL,'2관',10,2),(NULL,'3관',10,2),(NULL,'4관',12,2);
INSERT INTO SEAT VALUES
...
INSERT INTO schedule VALUES(NULL, '09:00', '2024-07-27', 1, 1, 3),
...
# 3관 - 08:40(조조), 17:00
# 4관 - 16:00
INSERT INTO schedule VALUES(NULL, '08:00', '2024-07-27', 1, 1, 4),
...
INSERT INTO price VALUES(NULL, '성인', 14000),(NULL, '청소년', 10000),(NULL, '조조 성인', 12000),(NULL, '조조 청소년', 8000);
# abc123 회원이 cgv강남 1관 10:00에 상영하는 데드풀과 울버린 성인 2장을 예매하는 쿼리
# 좌석은 A1, A2
INSERT INTO ticketing VALUES(NULL, 2, 0, 24000, 'abc123', 6);
