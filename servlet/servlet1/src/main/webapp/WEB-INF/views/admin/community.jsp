...
.link-community{
	...
	height: 100%; text-align: center; line-height: 30px; font-size: 24px;
...
$('.btn-update').click(function(){
	...
	var str = `
	<form class="input-group mb-3" action="<c:url value="/admin/community/update"/>" method="post" id="form_insert">
